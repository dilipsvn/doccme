...
<div id="ContentmainDesc">
	...
	<a href = "doctorOptions.php">Doctor Options</a>>>
	</div>
	<div id="resultBox">
	<form name="frmEditDoctor" id="frmEditDoctor" method="post" action="./editDoctorDetails.php">
	...
	<table border="0" cellpadding="2" cellspacing="2" width="95%">
		...
		<tr>
			...
			<td class = "inputbox"><?php $this->address2->showInput();  ?><font color = "red">
			<span id= "error_address2"><?php echo $this->address2_error; ?></span></font> </td>
		</tr>
