...
<div id="ContentmainDesc">
	...
	<a href="viewEditCourse.php">View / Edit Course</a>>>
	</div>
	<div id="resultBox">
	<form name="frmEditCourse" id="frmEditCourse" method="post" action="<?php $_SERVER["PHP_SELF"]?>" onsubmit="return doValidate();">
	...
	<table border="0" cellpadding="2" cellspacing="2" width="95%">
		...
		<tr>
			...
			<td class = "inputbox"><?php $this->courseTitle->showInput();?><font color="red">*
			<span id="error_courseTitle"><?php echo $this->courseTitle_error; ?></span></font> </td>
		</tr>
		<tr>
			<td  class = "labelOfInput"><?php $this->courseDesc->showLabel();?></td>
			<td class = "inputbox"><?php $this->courseDesc->showTextarea();?><font color="red"> 
			<span id="error_courseDesc"><?php echo $this->courseDesc_error; ?></span></font> </td>
		</tr>
		<tr>
			...
			<b><u>Help?</u></b></a></td>
			<td class = "inputbox"><?php $this->specialityField->showInput();?><font color="red">*
			<span id="error_specialityField"><?php echo $this->specialityField_error; ?></span></font> <br/>
			<?php $this->speciality->showSelectList($this->SpecialityList); ?><font color="red">*
			<input type="button" name="btnAdd" value="ADD" onclick="doAdd();" />
			<span id="error_speciality"><?php echo $this->speciality_error; ?></span></font><br/> 
		...
		<tr>
			...
			<td class = "inputbox"><?php $this->city->showInput();?><font color="red">*
			<span id="error_city"><?php echo $this->city_error; ?></span></font> </td>
		</tr>
		<tr>
			<td  class = "labelOfInput"><?php $this->state->showLabel();?> </td>
			<td class = "inputbox"><?php $this->state->showSelectList($this->StateList);?><font color="red">*
			<span id="error_state"><?php echo $this->state_error; ?></span></font></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class = "inputbox"> <?php $this->lastDateForApp->showInput();  ?><font color="red">*<a href="javascript:NewCal('lastDateForApp','mmddyyyy');"><img src="./images/dtp.gif" width="16" height="16" border="0" alt="Pick a date"></a>
			<span id="error_lastDate"><?php echo $this->lastDateForApp_error; ?></span></font></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class = "inputbox"><?php $this->courseFee->showInput();  ?><font color="red">*
			<span id="error_courseFee"><?php echo $this->courseFee_error; ?></span></font></td>
		</tr>
		<tr>
			<td  class = "labelOfInput"><?php $this->cmeCredits->showLabel(); ?> </td>
			<td class = "inputbox"><?php $this->cmeCredits->showInput();  ?><font color="red">*
			<span id="error_cmeCredits"><?php echo $this->cmeCredits_error; ?></span></font></td>
		</tr>
		<tr>
