...
function checkWorkPhone()
{
	...
	{
		document.getElementById("error_workPhone").innerHTML = "Please enter WorkPhone";
		document.getElementById("workPhone").focus();
		return false;
	}
}
...
function checkFax()
{
	...
	{
		document.getElementById("error_fax").innerHTML = "Please enter fax";
		document.getElementById("fax").focus();
		return false;
	}
}
