...
<div id="ContentMainDesc">
	...
	<div class="textContent">
		...
		<p>Details of courses are available. To book a course you need to <a href="./docRegister.php"><span class="highlightContent"> register in the CME program </span></a></p>
	</div>
	...
	?>
					<tr>
					<td class="tabledata"><?php echo $courses["CourseId"]; ?></td>
