...
class Page
{
	...
	function Page()
	{
		...
		if($this->PageAction=="SEARCH")
		{
			...
			{			
				session_write_close();
				header("location:./searchCMECourseResults.php?PageAction=SEARCH".$queryString);
			}
		}
	...
	{
		include("./html/html.searchCMECourse.php");
	}
...
$myPage = new Page();
$mPage = new Main("CME Course Search",$myPage, $myPage->role);
$mPage->showPage();
