 ...
 *
 *	Admin assigns full access status to all
...
class Page
{
	...
	function Page()
	{
		...
		$this->error = $this->bal->assignFullAccessToAllDoctors($result);
	...
	{
		include("./html/html.fullAccessDoctors.php");
	}
}
$myPage = new Page();
$mPage = new Main("Full Access to Doctors", $myPage, $myPage->role);
$mPage->showPage();
session_write_close();
?>