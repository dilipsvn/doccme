...
<div id="ContentmainDesc">
	...
	<a href = "searchCMEProvider.php">Search CME Provider</a>>>
	</div>
	<div id="resultBox">
	<?php
	$id = $_GET["id"];
	...
	{
		echo "Cme Provider details have been updated successfully";
	}
	if($_GET["msg"]== "successcmepass")
	{
		echo "Cme Provider password reset successful";
	}
	?>
	<form name="frmEditCMEProvider" id="frmEditCMEProvider" method="post" action="./editCMEProviderDetails.php?id=<?php echo $id;?>">
	...
	<tr>
		...
		<tr>
			...
			<font color ="red"><span id = "error_status"><?php echo $this->status_error; ?></span></font>
			</td>
		</tr>
		<tr>
  ...
  <input type="hidden" name="PageAction" id="PageAction" value="RESET" />
  	<tr>
		...
		<font color ="red"><?php echo $this->newPassword_error; ?>
		 </td>
	</tr>
	<tr>
		<td  class = "labelOfInput"><?php $this->confirmNewPassword->showLabel(); ?> </td>
		<td class = "inputbox"><?php $this->confirmNewPassword->showInput();  ?></font>
