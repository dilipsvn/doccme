...
<div id="ContentMainDesc">
	...
	if($_GET["msg"] == "success")
	{
		echo "Course Status has been updated successfully";
	}
	?>
	</div>
	...
	<?php
		...
		$this->error = $this->bal->getAppliedCoursesWithLimits($result, $from, $pageCount, $count);
		if($result != null)
		{
		?>
		<div class="textContent">
		There are <?php echo $count;?> pending courses to be booked
		</div>
	...
	<br/>
		...
		?>
				<tr>
					<td class="tabledata"><a href = "./bookCourse.php?id=<?php echo $course["BookingId"];?>"><?php echo $course["BookingId"];?></a></td>
					<td class="tabledata"><a href="viewDoctorDetails.php?id=<?php echo $course["DoctorId"]; ?>"><?php echo $course["DoctorId"]; ?></a></td>
					<td class="tabledata"><a href="viewCourseDetails.php?id=<?php echo $course["CourseId"]; ?>"><?php echo $course["CourseId"]; ?></a></td>
					<td class="tabledata"><?php echo $course["PaymentMode"];?></td>
					<td class="tabledata"><?php echo "$".$course["Amount"];?></td>
					<td class="tabledata"><a href="viewAgentDetails.php?id=<?php echo $course["AgentId"]; ?>"><?php echo $course["AgentId"]; ?></a></td>
					<td class="tabledata"><?php echo $course["BookStatus"];?></td>
			</tr>
	<?php
			}
		?>
	...
	<br/>
			...
			<tr>	
				<tr>	
					...
					<th class ="tabledatahead">DoctorID</th>
					<th class ="tabledatahead">CourseId</th>
					<th class ="tabledatahead">BookingDate</th>
					<th class ="tabledatahead">PaymentMode</th>
					<th class ="tabledatahead">Amount</th>
					<th class ="tabledatahead">AgentId</th>
					<th class ="tabledatahead">BookingStatus</th>
