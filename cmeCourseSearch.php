 ...
 *
 * 	this class enables a doctor to
 *	search approved cme courses by
 * 	entering appropriate search criteria
 *
 *	revised on May 31, 2007
 *	added code for validation of fields
 *	for search criteria
 */
session_start();
...
class Page
{
	...
	if($this->PageAction=="SEARCH")
	{
		...
		{
			session_write_close();
			header("location:./cmeCourseSearchResults.php?PageAction=SEARCH".$queryString);
		}
	}
	...
	{
		include("./html/html.CMECourseSearch.php");
	}
